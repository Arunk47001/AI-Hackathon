...
choose suitable response from the below
1. "Market"
...
"what is the value onion today?"etc
Your Output: "Market": "audio to Text"
2. "Scheme"
...
Your Output: "Scheme": "audio to Text"
3. "Diagnosis"
...
Your Output: "Diagnosis" : "audio to Text"
4. "Navigate"
...
Your Output: "Navigate" : "audio to Text"
if not relevant to anything,
Your Output: "Not Relevant": "audio to Text"
Only respond with one of the following exact words: **"Market"**, **"Scheme"**, **"Navigate"** or **"Not Relevant"**.
along with audio translation
Response should be following format:
Response : "translate the audio into in which the language was" 
'''

def transaudioDefinition():
    return '''translate the audio into in which the language was'''

def marketaudioDefinition(history):
...
dont say go and check website and article , give strong confirmation
Please speak in Kannada only

Chat history: {history}
"""


def schemeaudioDefinition(history):
...
always respond in the same language which user asked
its a  mobile app chatbot don't show more content it should be convenient for user to read it
dont say go and check website and article , give strong confirmation
Please speak in Kannada only
Chat history: {history}
...
def navigationaudioDefinition(history):
...
def standardaudioResponse():
    return f'''Response: I'm an Kisan Dost for farmer, I dont have any emotion, ask anything related to Crop
    always respond in the same language which user asked
    Please talk the above in Kannada what ever asks
    '''


def cropDiagnosisaudioPrompt(history):
...
4. Share Resources:
- Include **YouTube video links** or **articles** at the end that show similar symptoms or offer how-to guides.
